<template>
    <div class="product-catalog-card-card">
        ...
        <div class="button-container">
            <button :class="cart[String(product.id)]?'hidden':''" @click="addProduct(props.product)" id="add-button">
                Add
            </button>
            <div :class="cart[String(product.id)]?'':'hidden'" id="counter-container">
                <button @click="deleteProduct(props.product)" id="decrement-button">
                ...
                <button @click="addProduct(props.product)" id="increment-button">
