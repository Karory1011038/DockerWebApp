<template>
    <div class="product-catalog-card-card">
        ...
        <div class="button-container">
            <button class="animate" :class="cart[String(product.id)]?'hidden':''" @click.stop="addProduct(props.product)" id="add-button">
                Add
            </button>
            <div :class="cart[String(product.id)]?'':'hidden'" id="counter-container">
                <button @click.stop="deleteProduct(props.product)" class="animate" id="decrement-button">
                ...
                <button @click.stop="addProduct(props.product)" class="animate" id="increment-button">
